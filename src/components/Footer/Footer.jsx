...
Si deseas comunicarte con nosotros para comprender más sobre esta Política o deseas comunicarte con nosotros en relación con cualquier asunto sobre los derechos individuales y tu información personal, puedes enviarnos un correo electrónico a infodolarblueco@gmail.com.
</div>)

    const termsOfUse = (<div>
¡Bienvenido a DolarBlue.co!

Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de DolarBlue.co, ubicado en https://dolarblue.co.

Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando DolarBlue.co si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.

Cookies:
El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a DolarBlue.co, aceptaste utilizar las cookies necesarias.
...
Licencia:
A menos que se indique lo contrario, DolarBlue.co y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en DolarBlue.co. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde DolarBlue.co para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.

No debes:

Copiar o volver a publicar material de DolarBlue.co
Vender, alquilar o sublicenciar material de DolarBlue.co
Reproducir, duplicar o copiar material de DolarBlue.co
Redistribuir contenido de DolarBlue.co
Este acuerdo comenzará el fecha presente.

Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. DolarBlue.co no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de DolarBlue.co, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, DolarBlue.co no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.

DolarBlue.co se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
...
Por la presente, otorgas a DolarBlue.co una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
...
Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a DolarBlue.co. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
...
No se permitirá el uso del logotipo de DolarBlue.co u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
...
Siempre que el sitio web y la información y los servicios en el sitio se proporcionen de forma gratuita, no seremos responsables de ninguna pérdida o daño de cualquier naturaleza.    
    ...
    const handleClick = (e) => {
        if (e.target.innerText === "Política de Privacidad") {
            Swal.fire({
                title: 'Política de Privacidad',
                html: "<textarea class=" + "termsOfUse" + " >" + politicaDePrivacidad.props.children + "</textarea>",
                icon: 'info',
            ...
            html: "<textarea class=" + "termsOfUse" + " >" + termsOfUse.props.children + "</textarea>",
            icon: 'info',
            confirmButtonText: 'Aceptar'
    ...
    return (
        <Paper elevation={3} sx={{ width: "100%", height: "100%", backgroundColor: "#FFFFFF", marginTop: "5%", color: "#414141", display: "flex", justifyContent: "center", alignItems: "center" }}>
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <Item xs={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <p className='legales' onClick={(e) => handleClick(e)}>Términos de Uso</p>
                        <p className='legales' onClick={(e) => handleClick(e)}>Política de Privacidad</p>
                    </Item>
                </Grid>
